...
export const PLAYER_LIST_FOUND_MESSAGE = "Player list found.";
export const PLAYER_LIST_NOT_FOUND_MESSAGE = "Player list not found.";
...
export const VALIDATION_ERROR_MESSAGES = {
    ...
    ERR_MSG_004: "Player country ID must be a number.",
    ERR_MSG_005: "Player country ID must be an integer.",
    ERR_MSG_006: "Player country ID is required.",
    ERR_MSG_007: "Player country ID must be a positive integer.",
